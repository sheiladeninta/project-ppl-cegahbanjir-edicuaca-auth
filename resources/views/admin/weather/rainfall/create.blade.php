            ...
            <form action="{{ route('admin.weather.rainfall.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" class="form-control @error('recorded_at') is-invalid @enderror" id="recorded_at" name="recorded_at" value="{{ old('recorded_at') ?? now()->format('Y-m-d\TH:i') }}" required>
                        @error('recorded_at')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('rainfall_amount') is-invalid @enderror" id="rainfall_amount" name="rainfall_amount" value="{{ old('rainfall_amount') }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('intensity') is-invalid @enderror" id="intensity" name="intensity" value="{{ old('intensity') }}">
                        @error('intensity')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
